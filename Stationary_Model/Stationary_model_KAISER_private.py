...
if __name__ == "__main__":
    ...
    if do_empirical_estimation:
        ...
        est_sigmas, est_ls, smooth_ls, est_stds, est_R, est_B, est_L_vecs, est_tilde_sigma2_err = empirical_estimation.local_estimation(x_train.numpy(), Y_train.numpy() + 0.1 * np.random.randn(*Y_train.shape))
